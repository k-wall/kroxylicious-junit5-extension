...
public class KafkaClusterConfig {
     ...
     */
    public Stream<ConfigHolder> getBrokerConfigs(Supplier<KafkaListenerSource> endPointConfigSupplier) {
        List<ConfigHolder> properties = new ArrayList<>();
        KafkaListenerSource kafkaListenerSource = endPointConfigSupplier.get();
    ...
    /**
     * Generates client connection config to kafkaNet to the anonymous listeners within the cluster. Thus bypassing all authentication mechanisms.
     *
    ...
    /**
     * Generates client connection config to kafkaNet to the cluster via the supplied bootstrap address.
     *
     * @param bootstrapServers the bootstrap servers
     * @return the kafkaNet config for cluster
     */
    ...
    /**
     * Generates client connection config to kafkaNet to the cluster via the supplied bootstrap address and user credentials.
     *
     * @param bootstrapServers the bootstrap servers
     * @param user the user
    ...
    /**
     * Generates client connection config to kafkaNet to the cluster via the supplied bootstrap address and authentication configuration.
     *
     * @param bootstrapServers the bootstrap servers
     * @param user the user
     * @param password the password
